...
const Property = ({ prop: { externalID, coverPhoto, price, rentFrequency, rooms, title,
    baths, area, agency, isVerified } }) => {
    return (
                ...
                <Box w="full">
                    <Flex paddingTop="2" alignItems="center" justifyContent="space-between">
                        <Flex alignItems="center">
                            ...
                            <Text fontWeight="bold" fontSize="large">AED {millify(price)}
                                {rentFrequency && `/${rentFrequency}`}</Text>
                        </Flex>
                        <Box>
                    ...
                    <Text fontSize="lg">
                        {title.length > 30 ? `${title.substring(0, 30)}...`
                            : title}
                    </Text>
                </Box>
            </Flex>
